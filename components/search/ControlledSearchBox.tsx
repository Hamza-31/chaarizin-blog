		...
		>
			<label htmlFor="query" className="mb-2 text-sm font-medium relative flex justify-end">
				...
				<input
					...
					value={value}
					name='query'
					className="opacity-70 min-[400px]:w-[300px] w-full hover:opacity-100 focus:outline-none focus:opacity-100 transition ease-in-out duration-200 bg-beige rounded-sm text-dark-purple block p-4 text-sm" placeholder="Moisture, Oil ..." required />
